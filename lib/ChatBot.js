...
class ChatBot extends Component {
  ...
  onButtonPress(e,fromImagePicker=false) {
    ...
    const isInvalid = ( this.checkInvalidInput()) || (fromImagePicker &&!imageValue);
    ...
    return (
      ...
      >
        ...
        >
          ...
          >
            {showImagePicker && editable &&<View style={imagePickerContainerCustomStyle}>
              <TouchableOpacity style={imagePickerCustomStyle} activeOpacity={0.8} onPress={this.onImagePickerClick}>
                <Text style={imagePickerTextCustomStyle}>{`+`}</Text>
                </TouchableOpacity>
            </View>}
